...
export default function EditorArea({ activeFile }: Props) {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-editor">
      {/* Breadcrumb */}
      <div className="flex items-center gap-[6px] px-4 py-[7px] text-[12px] border-b flex-shrink-0 text-text-secondary border-border-light bg-editor no-scrollbar">
        <span>portfolio</span>
      ...
      <div
        key={activeFile}
        className="flex-1 overflow-y-auto overflow-x-hidden no-scrollbar py-6 relative fade-in"
      >
